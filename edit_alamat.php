<?php
	...
	if(isset($_POST['submit'])){
		$alamat = $_POST['alamat'];
		$sql_update = "update profile set alamat='$alamat' where email='".$_SESSION['s_email']."';";
...
<div class="container">
	...
	<table class="table">
		<tr>
			...
			<td class="col-md-6"><?php echo $data['nama_lengkap']; ?></td>
			<td class="col-md-2"><a href="edit_nama.php">Suting</a></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<form action="" enctype="multipart/form-data" method="post">
					<td class="col-md-6">
						<textarea type="text" class="form-control" name="alamat" value="<?php echo $data['alamat']; ?>" placeholder="alamat"></textarea>
					</td>
					<td class="col-md-2">
